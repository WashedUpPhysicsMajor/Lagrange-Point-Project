...
int main() {
    ...
    for(int k = 1; k < K; k++){
        ...
        boost = 0.0004+step*k;//change this after
        boosta[k-1] = boost;
...
//fuelsearch1 is broad search
//fuel search2 is search around 0
//fuel search3 is search around 0.000434