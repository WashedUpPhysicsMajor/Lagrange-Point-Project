...
X3 <- 1.00957331597868*1.496*10^11#stable points from paper
Ax3 <- 0
Y3 <- 0
Vx3 <- 0  
Vy3 <- 30.2 * 10^3 +0.002915011430785#
Ay3 <- 0
Z3 <- 0
Vz3 <-0  #L2
Az3 <- 0
...
dev.off()
plot(seq(0,N/4000,by=1),sqrt((X3Pos-X2Pos)^2+(Y3Pos-Y2Pos)^2+(Z3Pos-Z2Pos)^2), type ="p", col = "blue", xlab = "Time (Arb)", ylab = "Distance Between L5 - Earth")
x#plot(X3Pos,Z3Pos,type = "p")
