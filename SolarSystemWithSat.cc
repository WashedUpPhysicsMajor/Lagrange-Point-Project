...
int main(){
    ...
    double M6 = 1000;
    double X6 = 1.4960e11+6378100+2000e3, Vx6 =0, Ax6 = 0, Y6 = 0, Vy6 = 29.78e3+13000, Ay6 = 0, Z6 = 0, Vz6 = 0, Az6=0;

    double detT = 1;
    int N = 800000*10;
    int a = 0;

    double X1Pos[N/400+1];
    double Y1Pos[N/400+1];
    double Z1Pos[N/400+1];
    double X2Pos[N/400+1];
    double Y2Pos[N/400+1];
    double Z2Pos[N/400+1];
    double X3Pos[N/400+1];
    double Y3Pos[N/400+1]; 
    double Z3Pos[N/400+1];
    double X4Pos[N/400+1];
    double Y4Pos[N/400+1];
    double Z4Pos[N/400+1];
    double X5Pos[N/400+1];
    double Y5Pos[N/400+1];
    double Z5Pos[N/400+1];
    double X6Pos[N/400+1];
    double Y6Pos[N/400+1];
    double Z6Pos[N/400+1];
    ...
    ofstream file;
    file.open("solarsystemwithsat.csv");
    for (int j = 0; j <= a; j++){
